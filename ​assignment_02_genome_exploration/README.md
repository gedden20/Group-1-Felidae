...
* **Description:** This workflow encapsulates all automated steps executed in Galaxy for the *Panthera tigris* genome assembly exploration, length filtering, and ORF analysis.
